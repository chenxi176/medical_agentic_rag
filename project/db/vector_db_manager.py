...
class VectorDbManager:
    ...
    def __init__(self):
        ...
        self.__dense_embeddings = HuggingFaceEmbeddings(model_name="/root/autodl-tmp/agentic-rag-for-dummies-main/project/bge-large-zh-v1.5")
        self.__sparse_embeddings = FastEmbedSparse(model_name="Qdrant/bm25",cache_dir="/root/autodl-tmp/agentic-rag-for-dummies-main/project",local_files_only=True)
